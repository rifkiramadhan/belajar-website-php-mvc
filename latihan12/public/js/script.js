...
$(function() {
    ...
    $('.tampilModalUbah').on('click', function() {
        ...
        */
        $('.modal-body form').attr('action', 'http://localhost/Belajar%20PHP%20MVC/latihan12/public/mahasiswa/ubah');
        ...
        $.ajax({
            ...
            url: 'http://localhost/Belajar%20PHP%20MVC/latihan12/public/mahasiswa/getubah',
